...
- `executor_git_manager` is the execution-layer Git Manager Subagent. It may explain branch/status/diff/worktree/push readiness, but Git commit and push flows must stay approval-gated through `git_worktree_manager` or other Core-approved tools.
