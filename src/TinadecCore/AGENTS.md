...
- `executor_git_manager` is the dedicated Git Manager Subagent. Bind read goals plus `git_stage` / `git_unstage` to
  approval-gated TinadecTools descriptors; keep `git_worktree_manager` for commit/push and legacy compatibility.
