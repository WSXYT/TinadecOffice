...
**Last Updated By:** Codex (Git worktree tools)
**Last Verified Commit:** e9630ea
**Branch:** main
...
- `executor_git_manager` is the execution-layer Git Manager Subagent. It may explain branch/status/diff/worktree/push readiness; index, commit, branch, and managed worktree mutations execute through approved TinadecTools calls, while push and the remaining Git mutations stay approval-gated through `git_worktree_manager` until migrated.
